 ...
 * @copyright Justin Soon & Kevin Yoon
 */
(function BuskeyJump($, Crafty) {
    $(document).ready(function documentReady() {
        ...
        Crafty.c("Push", {
            ...
            init: function () {
                ...
                this._label = Crafty.e("2D, DOM, Text").attr({
                    ...
                    y: this.y,
                    w: this.w
                }).textColor("#ffffff").text("Dr. Pepper").css({
        ...
        Crafty.c("Pull", {
            ...
            init: function () {
                ...
                this._label = Crafty.e("2D, DOM, Text").attr({
                    ...
                    y: this.y,
                    w: this.w
                }).textColor("#ffffff").text("Rule#1&2").css({
                    "font": "18px Chewy, Arial",
                    "text-align": "center",
                    // 'textShadow': '0px 1px 2px #000'
        ...
        function onHitCorvette(a) {
            var e = a[0].obj,
                buskey = Crafty("Player"),
                bg = Crafty("Background"),
                bgovr = Crafty("BackgroundOverlay");
            // e.removeComponent("Pickup", false);
            e.removeComponent("Pickup");
            e.removeComponent("Corvette");
            e.destroy();

            Corvettes++;

            if(SFX) Crafty.audio.play("Corvette", 1, 0.5);
            ...
            // buskey.delay(buskey.enableControls, 500);
            ...
            buskey.delay(function () {
                ...
                this.x = p.x;
                this.y = p.y - buskey.h / 2;
                this._speed.y = Math.min(-1, -this._speed.y);

                buskey.enableControls();
                // buskey.unbind("EnterFrame", f);
                Crafty.e("2D, DOM, Portal, SpriteAnimation").animate("portal", 0, 0, 10).animate("portal", 5, 0).attr({
                    x: this.x - 48,
                    y: this.y - 48,
                    w: 192,
        ...
        Crafty.scene("main", function mainScene() {
           ...
           /* var clone = Crafty.e("2D, DOM, BusClone, buskey, SpriteAnimation, Tween, Delay").origin('center').attr({
                x: 160,
            ...
            var buskey = Crafty.e("2D, DOM, Player, buskey, SpriteAnimation, Physics, PlayerControls, Collision, Tween, Delay").origin('center').setName("buskey").attr({
                x: 160,
                y: Crafty.canvas._canvas.height / 2 - 48,
                z: 999
            }).animate("walk", 0, 0, 3).animate('walk', 5, -1)
            ...
            .collision(new Crafty.circle(48, 48, 32)).onHit("Star", onHitStar).onHit("Corvette", onHitCorvette).onHit("Platform", onHitPlatform);
            ...
            /* function updateClone(e) {
                // var ov = new Crafty.math.Vector2D(buskey.x, buskey.y),
            ...
            (function (vp) {
                function updatebuskey(e) {
                    var y = this.y;
                    // this.animate('walk', 5, - 1);
                    // Crafty.viewport.scroll('y', Crafty.viewport.height/2 - buskey.y);
                    ...
                    if(isDead) {
                        ...
                        Crafty.unbind("EnterFrame", scrollViewport);
                        this.unbind('EnterFrame', updatebuskey);
                        setTimeout(function () {
                            Crafty.scene('dead');
                        }, 750);
                        return;
                ...
                buskey.bind("EnterFrame", updatebuskey);
            })(Crafty.viewport);
        ...
        Crafty.scene("loading", function () {
            ...
            Crafty.background("#fff");
            // Crafty.background("url('assets/images/buskey-spinner-128.gif') no-repeat center center #fff");
            ...
            //     //     z: 3,
            //     //     alpha: 0
            //     // }).image('assets/images/buskey-spinner-128.gif').tween({
            //     //     alpha: 1
            //     // }, 50);
            // });
            var images = [];
            ...
            Crafty.load(images.map(imgPath), function onLoad() {
                ...
                // Crafty.sprite(96, R.buskey_PNG, {
                Crafty.sprite(96, "assets/images/buskey.png", {
                ...
                Crafty.audio.add({
                    ...
                    Corvette: ["Corvette.mp3", "Corvette.ogg", "Corvette.wav"].map(sndPath),
        ...
        Crafty.scene("intro", function initIntro() {
            ...
            Crafty.e("2D, Canvas, Image, Tween, Delay").attr({
                ...
                y: (640 - 174) / 2,
                alpha: 0
            }).image('assets/images/dev.png').tween({
